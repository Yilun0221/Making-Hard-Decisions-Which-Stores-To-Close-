...
params_dict = {'p_3':'J_POI_count_where_store_is', 'p_6':'G_Distance_between_cbg_and_store'}
...
PSO_results = {'cbg':[], 'cost':[], params_dict['p_3']: [], params_dict['p_6']: []}
comm = MPI.COMM_WORLD
size = comm.Get_size()
rank = comm.Get_rank()
...
'''
#r_walks = []
fields=['cbg','cost','J_POI_count_where_store_is', 'G_Distance_between_cbg_and_store']
with open('/home/yilunx/Desktop/new_PSO_20220325/calibrations/G_J/sub_' + str(year) +'/PSO_2params_NYC_G_J_sub_' +str(rank) + '_' + str(year) + '.csv', 'a') as myfile:
