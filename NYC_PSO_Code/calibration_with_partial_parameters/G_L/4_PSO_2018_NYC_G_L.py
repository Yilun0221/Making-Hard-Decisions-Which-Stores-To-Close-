...
params_dict = {'p_5': 'L_Demographic_similarity', 'p_6':'G_Distance_between_cbg_and_store'}
...
PSO_results = {'cbg':[], 'cost':[], params_dict['p_5']: [], params_dict['p_6']: []}
comm = MPI.COMM_WORLD
size = comm.Get_size()
rank = comm.Get_rank()
...
'''
#r_walks = []
fields=['cbg','cost','L_Demographic_similarity', 'G_Distance_between_cbg_and_store']
with open('/home/yilunx/Desktop/new_PSO_20220325/calibrations/G_L/sub_' + str(year) +'/PSO_2params_NYC_G_L_sub_' +str(rank) + '_' + str(year) + '.csv', 'a') as myfile:
